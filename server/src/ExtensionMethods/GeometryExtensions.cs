// FIXME: this file was copied from krpc1, and a few methods added. Can we move this to krpc-core?
// Would need to add a dependency of krpc-core on unity
...
using Tuple4f = System.Tuple<float, float, float, float>;
...
namespace KRPC2.ExtensionMethods
{
    ...
    public static class GeometryExtensions
    {
        ...
        /// <summary>
        /// Convert a vector to tuple
        /// </summary>
        public static Tuple4 ToTuple(this Vector4 v)
        {
            return new Tuple4(v.x, v.y, v.z, v.w);
        }

        /// <summary>
        /// Convert a vector to tuple
        /// </summary>
        public static Tuple4 ToTuple(this Vector4d v)
        {
            return new Tuple4(v.x, v.y, v.z, v.w);
        }
        ...
        /// Convert a vector to tuple
        /// </summary>
        public static Tuple4f ToTupleF(this Vector4 v)
        {
            return new Tuple4f(v.x, v.y, v.z, v.w);
        }

        /// <summary>
        /// Convert a vector to tuple
        /// </summary>
        public static Tuple4f ToTupleF(this Vector4d v)
        {
            return new Tuple4f((float)v.x, (float)v.y, (float)v.z, (float)v.w);
        }
        ...
        /// Convert a tuple to a vector
        /// </summary>
        public static Vector4d ToVector(this Tuple4 t)
        {
            if (t == null)
                throw new ArgumentNullException(nameof(t));
            return new Vector4d(t.Item1, t.Item2, t.Item3, t.Item4);
        }

        /// <summary>
        /// Convert a tuple to a vector
        /// </summary>
        public static Vector4 ToVectorF(this Tuple4f t)
        {
            if (t == null)
                throw new ArgumentNullException(nameof(t));
            return new Vector4(t.Item1, t.Item2, t.Item3, t.Item4);
        }

        /// <summary>
        /// Convert a tuple to a vector
        /// </summary>
        public static Vector4 ToVectorF(this Tuple4 t)
        {
            if (t == null)
                throw new ArgumentNullException(nameof(t));
            return new Vector4((float)t.Item1, (float)t.Item2, (float)t.Item3, (float)t.Item4);
        }
